/* Inspección numérica de los PNG capturados (sin dependencias).
...
for (const f of readdirSync("vistas-v2").sort()) {
  console.log(JSON.stringify(analyze(join("vistas-v2", f))));
}
