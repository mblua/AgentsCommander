/**
 * Construye `index.html`: un único archivo autocontenido (sin build de Vite,
...
const piece = (rel) => readFileSync(join(here, "piezas", rel), "utf8");
...
<head>
<meta charset="utf-8" />
<title>Prototipo · Candados de selección (Coding Agent + Profile)</title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<link rel="icon" href="data:," />
<!--
  PROTOTIPO DE MAQUETAS — no es producto.
  Generado por construir.mjs desde repo-AgentsCommander @ ${sha}.
...
console.log(`index.html generado (${kb} KB) — repo @ ${sha}`);
