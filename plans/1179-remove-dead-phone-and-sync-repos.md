...
Certified by `architect` at Step 7 round 3, as corrected on the locality clause. Three digests are **superseded**: round 1 `FD9E52B772DAAC360DA773614F957596F21BED0C44778A7B1E18422D12577AD4`, round 2 `C76B945165A30A32315177C7E4D55D7C4E063FC19ED6449D4BBCE6445A5DCA18`, round 3 `1C5FD18BB0BF9BFCE74F95B6BB1150E1324B89BD8922BBA82F2821BD18AEB1C2`.

**The code is done and correct.** Batches 1 through 4 landed and passed review; every defect found since has been in documentation wording that this plan specifies, not in the implementation. `docs/security.md:14` and `PRIVACY.md:29-31` are rewritten to be bounded and non-categorical (§4.6, §4.2, standard in §4.6.1), with locality stated as a default rather than unconditionally (§13.6), gates rebuilt around both (§9.3 rule 9), and both shipping as **batch 5** (§8.7). Records: §13 for round 1's enrichment resolution (`dev-rust` E1-E7, `dev-rust-grinch` G1-G7), §13.4 for round 2, §13.5 for round 3, §13.6 for the locality correction.
...
#### Certification (round 3, corrected)

This plan is certified `READY_FOR_IMPLEMENTATION` as of the Step 7 round-3 locality correction. The certified artifact is the committed file; any byte change after the certifying commit invalidates this status and requires re-certification.
