...
pub const fn safe_detail(code: PtyInputReasonCode) -> &'static str {
    ...
    match code {
        ...
        C::InvalidTarget => "An exact canonical workgroup target is required.",
        ...
        C::SenderNotCoordinator => "The sender is not the verified workgroup coordinator.",
        C::RootIdentityInvalid => "The live Root Agent identity could not be verified.",
        C::TargetNotMember => "The target is not a verified member of the sender workgroup.",
        C::TargetIsCoordinator => "A coordinator cannot target a coordinator on this route.",
        ...
        C::PurgeInProgress => "Workgroup purge temporarily blocks target preparation.",
