...
- **API keys live in plaintext** in `settings.json` under the active selected configuration directory. Protect your user account and any override, adjacent, or home-fallback path it selects; if your account is compromised, the keys are.
