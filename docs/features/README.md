...
| [Screenshot capture](screenshot-capture.md) | Press a global hotkey, drag a rectangle, and save a PNG inside the replica that owns your session. Windows, macOS and Linux/X11. |
...
| [Seed manifest](seed-manifest.md) | Read the diagnostic inventory of the project-scoped files AC published into your project's `.ac` folder. |
